...
int main()
{
	LPCTSTR pszReportJson = TEXT("E:/GIT/data_example/report.json"); // 본인 경로에 맞게 수정1
	LPCTSTR pszReportXml = TEXT("E:/GIT/data_example/report.xml"); // 본인 경로에 맞게 수정2
	LPCTSTR pszTargetXml = TEXT("E:/GIT/data_example/target.xml"); // 본인 경로에 맞게 수정3
	try
	{
		ST_REPORT report;
